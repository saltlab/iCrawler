...
+ (id)stepToTapIfAvailableViewWithAccessibilityLabel:(NSString *)label;
{
    return [self stepToTapIfAvailableViewWithAccessibilityLabel:label traits:UIAccessibilityTraitNone];
}

+ (id)stepToTapIfAvailableViewWithAccessibilityLabel:(NSString *)label traits:(UIAccessibilityTraits)traits;
{
    return [self stepToTapIfAvailableViewWithAccessibilityLabel:label value:nil traits:traits];
}


+ (id)stepToTapIfAvailableViewWithAccessibilityLabel:(NSString *)label value:(NSString *)value traits:(UIAccessibilityTraits)traits;
{
    NSString *description = nil;
    if (value.length) {
        description = [NSString stringWithFormat:@"Wait for view with accessibility label \"%@\" and accessibility value \"%@\"", label, value];
