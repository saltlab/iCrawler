...
static const NSTimeInterval kEditHoldTimeInterval = 1000.0;
...
@synthesize rightArrow, leftArrow;
...
- (void)updateContentSize:(NSInteger)numberOfPages {
  ...
  if (numberOfPages != _pager.numberOfPages) {
	...
	[self updateArrows:_pager.currentPage];
...
- (void)updateArrows:(NSInteger)page {
	if ((self.leftArrow) && (self.rightArrow)) {
		if (page == _pager.numberOfPages - 1){
